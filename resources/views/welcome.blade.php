    ...
    <div class="container">
        <header class="py-3 mb-3 border-bottom">
            <div class="container-fluid gap-3 align-items-center" style="grid-template-columns: 1fr 2fr;">
                <div class="row">
                    <div class="col-md-3">
                        <div class="dropdown align-items-center" style="text-align: center;">
                            <a href="#"
                               ...
                               id="dropdownNavLink" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="fa fa-home" style="font-size: 28px;color: #95bf17;"></i>
                            </a>
                    ...
                    <div class="col-md-6">
                        <div class="align-items-center" style="text-align: center;">
                            <a href="#" class="d-block link-dark text-decoration-none" aria-expanded="false">
                                <img src="../assets/brand/logo.png" alt="mdo" width="60px" />
                            </a>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="align-items-center" style="text-align: center;">
                            <i class="fa fa-search" style="font-size: 28px;color: #95bf17;"></i>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col">
            <div class="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg">
                <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
                    <h2 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">منتجات بشرة</h2>
